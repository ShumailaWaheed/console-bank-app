...
class BankAccount {
    ...
    constructor(accountNumber: string, initialBalance: number, firstName: string, lastName: string, age: number, gender: string, cnic: string) {
...
class Bank {
    ...
    public createAccount(initialBalance: number, firstName: string, lastName: string, age: number, gender: string, cnic: string): string {
        const accountNumber = this.generateRandomAccountNumber();
        this.accounts.set(accountNumber, new BankAccount(accountNumber, initialBalance, firstName, lastName, age, gender, cnic));
    ...
    public viewAccount(accountNumber: string): string {
...
const questions = [
    ...
    },
    {
        ...
        when: (answers: any) => answers.action === "Create Account"
    },
    {
        type: "input",
        name: "lastName",
    ...
    },
    {
        ...
        when: (answers: any) => answers.action === "View Account Details" || answers.action === "Debit" || answers.action === "Credit",
        validate: (input: string) => {
    ...
    },
    {
        ...
        when: (answers: any) => answers.action === "Credit" || answers.action === "Debit",
        validate: (input: string) => {
...
const handleAction = async () => {
    ...
    switch (answers.action) {
        case "Create Account":
            console.log(bank.createAccount(
